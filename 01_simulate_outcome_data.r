...
### Run through 187 trials and simulate data with interactions
...
## Loop through creating multiple simulated datasets, use function

  ## Read in choice of parameters for simulation
res_list <- 
  map(1:6, function (i){
  sim_effects <- read_excel(path = paste0("data/sim_effects", i ,".xlsx"))
  print(paste0("Simulated effects ", i, "."))
  print(sim_effects)
  ...
  print ("should both be FALSE")
  print(any(!PrecCheck(sim_data$con)))
  print(any(!PrecCheck(sim_data$cat))) # should be FALSE
